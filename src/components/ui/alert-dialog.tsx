...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      'sm:flex-row sm:justify-end sm:space-x-3 flex flex-col-reverse',
      className,
    )}
    {...props}
  />
